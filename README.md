...
以下图片于 2026-09-18 从当前源码的 SwiftUI / AppKit 组件导出，统一使用匿名示例数据。截图覆盖最新平面统计分组、六款皮肤、模型费用、额度变动和任务详情；顶部“示例数据”是文档标识。独立悬浮卡展示组件内容，窗口位置和系统标题栏以实际运行为准。生成方法和完整清单见[截图说明](docs/images/README.md)。
